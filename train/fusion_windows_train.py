...
def train_and_evaluate_fusion_windows(
    ...
    *,
    ...
    cnn_result = run_training_experiment(
        **common,
        model_key="fusion_cnn_windowed",
        tuner_factory=lambda train, val, search: FusionCNNWindowTuner(
            train,
            val,
        ...
        trainer_factory=FusionCNNWindowTrainer,
        config=cnn_config,
    ...
    gru_result = run_training_experiment(
        **common,
        model_key="fusion_gru_windowed",
        tuner_factory=lambda train, val, search: FusionGRUWindowTuner(
            train,
            val,
            imu_checkpoint=intent_cnn_path,
            mmg_checkpoint=gesture_cnn_path,
        ...
        trainer_factory=FusionGRUWindowTrainer,
        config=gru_config,
